...
# Optional Bitcoin config directory - this is if you run in mainnet and have an extra drive that is not where the OS is mounted on, like an external hard drive
DIRECTORY=$6
